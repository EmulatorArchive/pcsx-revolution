...
#define GTE_RTPS2(vn) { \
	if (gteSZ##vn == 0) { \
		...
		FDSZ = ((u32)gteH << 16) / ((u32)gteSZ##vn); \
		if (FDSZ > (2 << 16)) { FDSZ = 2 << 16; gteFLAG |= 1<<17; } \
	} \
 \
	gteSX##vn = FlimG1((gteOFX + (((s32)((s32)gteIR1) * FDSZ))) >> 16); \
	gteSY##vn = FlimG2((gteOFY + (((s32)((s32)gteIR2) * FDSZ))) >> 16); \
}
...
#define _MVMVA_FUNC(_v0, _v1, _v2, mx) { \
	SSX = (s32)(_v0) * (s32)mx##11 + (s32)(_v1) * (s32)mx##12 + (s32)(_v2) * (s32)mx##13; \
	SSY = (s32)(_v0) * (s32)mx##21 + (s32)(_v1) * (s32)mx##22 + (s32)(_v2) * (s32)mx##23; \
	SSZ = (s32)(_v0) * (s32)mx##31 + (s32)(_v1) * (s32)mx##32 + (s32)(_v2) * (s32)mx##33; \
}
/*
#define _MVMVA_FUNC(_v0, _v1, _v2, mx) { \
	SSX = (double)(_v0) * (double)mx##11 + (double)(_v1) * (double)mx##12 + (double)(_v2) * (double)mx##13; \
	SSY = (double)(_v0) * (double)mx##21 + (double)(_v1) * (double)mx##22 + (double)(_v2) * (double)mx##23; \
	SSZ = (double)(_v0) * (double)mx##31 + (double)(_v1) * (double)mx##32 + (double)(_v2) * (double)mx##33; \
}*/
