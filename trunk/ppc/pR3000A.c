...
// Rd = Rt << Rs
	...
	if (IsConst(_Rt_) && IsConst(_Rs_)) {
		...
		SLW(PutHWReg32(_Rd_), GetHWReg32(_Rt_), (GetHWReg32(_Rs_) & 0x1f));
	}
}
...
// Rd = Rt >> Rs
	...
	if (IsConst(_Rt_) && IsConst(_Rs_)) {
		...
		SRW(PutHWReg32(_Rd_), GetHWReg32(_Rt_), (GetHWReg32(_Rs_) & 0x1f));
	}
}
...
// Rd = Rt >> Rs
	...
	if (IsConst(_Rt_) && IsConst(_Rs_)) {
		...
		SRAW(PutHWReg32(_Rd_), GetHWReg32(_Rt_), (GetHWReg32(_Rs_) & 0x1f));
	}
}
#endif
